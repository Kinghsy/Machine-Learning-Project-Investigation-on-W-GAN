...
parser.add_argument('--dataset', required=True, help='| 64x64 |')
...
dataloader = data_loader(opt.dataset, opt.batchSize)
    ...
    for i, x in enumerate(dataloader):
      ...
      if i % 10 == 0:
        vutils.save_image(real_imgs,
                          f'{opt.outf}/real_samples_epoch_{epoch}.png',
                          normalize=True)
